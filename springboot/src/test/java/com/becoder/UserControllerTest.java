...
class UserControllerTest {
    ...
    void requestDeletion_Success() throws UnsupportedEncodingException, MessagingException {
        ...
        String result = userController.solicitarEliminacion(principal, redirectAttributes);
    ...
    void confirmDeletion_TokenExpired() {
        ...
        String result = userController.confirmarEliminacion("token", redirectAttributes);
    ...
    void confirmDeletion_Success() {
        ...
        verify(userService).eliminarUsuario(user.getId());
        verify(redirectAttributes).addFlashAttribute(eq("sucessoEliminar"), any());
    }
    ...
    void changePassword_PasswordsDontMatch() {
        when(principal.getName()).thenReturn("user@mail.com");
        String result = userController.cambiarPassword("old", "new", "different", principal, redirectAttributes);
        assertEquals("redirect:/user/profile", result);
    ...
    void changePassword_WrongCurrentPassword() {
        ...
        String result = userController.cambiarPassword("old", "new", "new", principal, redirectAttributes);
